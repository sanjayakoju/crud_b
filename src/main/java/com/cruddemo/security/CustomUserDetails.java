...
public class CustomUserDetails implements UserDetails, OAuth2User {
    ...
    public static CustomUserDetails buildFromUserEntity(User userEntity) {
    ...
    public static CustomUserDetails buildWithAuthAttributesAndAuthorities(User userEntity,
                                                                          Collection<? extends GrantedAuthority> authorities,
                                                                          Map<String, Object> attributes) {
